...
**What should you do ?** *solution_data*
...
**Why was it like that ?** *solution_fastq1*
...
**Why was it like that?** *solution_fastq2*
...
**Why are there 2 different ones ?** *solution_trim1*
...
**What does Trimmomatic says it did ?** *solution_trim2*

Exercice: 
**Let's generate the new graphs** *solution_fastqQC2*

**How does it look now ?** *solution_trim3*


# Alignment
The raw reads are now cleaned up of artefacts we can align each lane separatly.

**Why should this be done separatly?** *solution_aln1*
...
**Why did we pipe the output of one to the other ?** *solution_aln3*

**Could we have done it differently ?** *solution_aln4*
...
**Why did we use the -H switch? ** *solution_merge1*

**Try without. What happens?** *solution_merge2*
...
**What do the flags of the first 4th reads mean?** [solutions](solutions/_sambam1*

Exercice:
**Let's take the 3rd one, the one that is in proper pair, and find it's mate.** [solutions](solutions/_sambam3*

**Why the pairing information is important ?**  [solutions](solutions/_sambam4*
...
Exercice:
**How many reads mapped and unmapped were there?** *solution_sambam2*
...
```
**Why did we use both normal and tumor together? ** *solution_realign3*

**How could we make this go faster ?** *solution_realign1*

**How many regions did it think needed cleaning ?** *solution_realign2*
...
**Why it is important ?***solution_realign4*
...
## Mark duplicates
**What are duplicate reads ?** *solution_markdup1*

**What are they caused by ?** *solution_markdup2*

**What are the ways to detect them ?** *solution_markdup3*
...
**How many duplicates were there ?** *solution_markdup4*

We can see that it computed separate measures for each library.
 
**Why is this important to do not combine everything ?** *solution_markdup5*

[Note on Duplicate rate](notes/_marduop1.md)

## Base Quality recalibration
**Why do we need to recalibrate base quality scores ?** *solution_recal1*
...
**Is the coverage fit with the expectation ?** *solution_DOC1*
...
**Can you tell what it is?** *solution_insert1*
...
**Do you think the sample and the reference genome fit together ?** *solution_alnMetrics1*
...
**Can you see the difference with the previous vcf ?** *solution_snpeff1*

Exercice: 
**Find a somatic mutation with a predicted High or Moderate impact** *solution_snpeff2*
